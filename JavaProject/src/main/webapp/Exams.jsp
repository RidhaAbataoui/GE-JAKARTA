...
<body>
	...
	<%
		...
		ResultSet rs;
		rs = con.createStatement().executeQuery("SELECT * FROM Examinier;");
	%>
	<table>
	    <caption><h1>Exams List : </h1></caption>
	    <thead>
	        <tr>
	            <th>Student ID</th>
	            <th>Teacher ID</th>
	...
	<div class="information_manipulation">
		<div class="add_class">
			<h1>Add Exam Record : </h1>
		    <form action="/JavaProject/ADDExam" method="post">
		  ...
		  <div class="delete_class">
			  <h1>Delete Exam Record : </h1>
			  <form action="/JavaProject/DeleteExam" method="post">
		        <div class="formcontainer">
		        <div class="container">
		  ...
		  <div>
			  <h1>Modify Exam Record : </h1>
			  <form action="/JavaProject/ModifyExam" method="post">
		        <div class="formcontainer">
		        <div class="container">
		          <input type="text" placeholder="Student ID : " name="studentIDModify" required>
		          <input type="text" placeholder="Teacher ID : " name="TeacherIDModify" >
		          <input type="text" placeholder="Mark : " name="MarkModify" >
		        </div>
